...
var app = http.createServer(function (request, response) {
  ...
  else if (pathname === '/delete_process') topic.delete_process(request, response); 
  else if(pathname === '/author') author.home(request,response);
  else if(pathname === '/author/create_process') author.create_process(request,response);
  else if(pathname === '/author/update') author.update(request,response);
  else if(pathname === '/author/update_process') author.update_process(request,response);
  else if(pathname === '/author/delete_process') author.delete_process(request, response);
  else topic.else(request, response);
});
app.listen(3000);
